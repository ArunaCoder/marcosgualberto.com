...
const items = Array.from(document.querySelectorAll<HTMLAnchorElement>(".rail__item"));
...
/* menu móvel */
const burger = document.querySelector<HTMLButtonElement>('[aria-controls="menu-movel"]');

...
if (!quiet) {
    ...
    const targets = document.querySelectorAll(".sd, .sdw");
    ...
    const bar = supportsScrollTimeline ? null : document.querySelector(".prog i");
    if (bar) {
        let ticking = false;
        const draw = () => {
...
/* menu móvel */
const burger = document.querySelector('[aria-controls="menu"]');
